...
def summarize(
    ...
    counted_dies = [d for d in dies if not d.get("manual_untested")]
    total = len(counted_dies)
    pass_count = sum(1 for d in counted_dies if d.get("pass"))
